...
- It is also recommended to only approve mitigations from this sandbox
...
- [Veracode All Links](https://docs.veracode.com/r/all_HC)
- [Veracode All Videos](https://docs.veracode.com/r/all_videos_HC)
- [Veracode Getting Started with the Platform](https://docs.veracode.com/r/start)
- [Veracode Getting Started with Static](https://docs.veracode.com/r/Static_Analysis_Quickstart)
- [Veracode Getting Started with Dynamic](https://docs.veracode.com/r/Dynamic_Analysis)
- [Veracode Getting Started with Software Composition Analysis](https://docs.veracode.com/r/c_integrated_benefits)
- [Veracode Getting Started with the APIs](https://docs.veracode.com/r/REST_APIs_Quickstart)
- [Veracode Getting Started with Security Labs](https://docs.veracode.com/r/Security_Labs_Quickstart)
...
- [Veracode Integration Hub](https://community.veracode.com/s/integrations)
- [About Veracode API Best Practices](https://docs.veracode.com/r/About_Veracode_API_Best_Practices)
- [Veracode Findings Best Practices](https://docs.veracode.com/r/review_bestpractices)
- [Veracode Greenlight Best Practices](https://docs.veracode.com/r/c_best_practices)
...
- [Veracode Blog | AppSec Best Practices ](https://community.veracode.com/s/knowledgeitem/appsec-best-practices-MC5HU2OIHZYFALPAZCKZL4AAITLU)
